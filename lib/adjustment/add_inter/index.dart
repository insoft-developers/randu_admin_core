...
class AdjustmentAddInterProduct extends StatefulWidget {
  const AdjustmentAddInterProduct({super.key});

  @override
  State<AdjustmentAddInterProduct> createState() =>
      _AdjustmentAddInterProductState();
}

class _AdjustmentAddInterProductState extends State<AdjustmentAddInterProduct> {
  final AdjustmentAddInterProductController _controller =
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: ListView(
        ...
        children: [
          ComunTitle(
              title: 'Penyesuaian Barang\n Setengah Jadi', path: "Penyesuaian"),
          Jarak(tinggi: 20),
          ...
          Obx(() => _controller.categoryLoading.value
              ...
              : SelectData(
                  ...
                  code: 'adjustment-add-inter-product-category',
                )),
          Jarak(tinggi: 30),
          ...
          Obx(() => _controller.categoryLoading.value
              ...
              : SelectData(
                  ...
                  code: 'adjustment-add-inter-product-account',
                )),
          Jarak(tinggi: 30),
          Container(
              margin: const EdgeInsets.symmetric(horizontal: 20),
              ...
              child: Row(
                ...
                children: [
                  SizedBox(
                    ...
                    child: Text("Masukkan produk setangah jadi penyesuaian",
                        style: TextStyle(
