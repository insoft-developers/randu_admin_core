...
class AdjustmentAddMaterial extends StatefulWidget {
  const AdjustmentAddMaterial({super.key});

  @override
  State<AdjustmentAddMaterial> createState() => _AdjustmentAddMaterialState();
}

class _AdjustmentAddMaterialState extends State<AdjustmentAddMaterial> {
  final AdjustmentAddMaterialController _controller =
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: ListView(
        ...
        children: [
          ComunTitle(title: 'Penyesuaian Bahan \nBaku', path: "Penyesuaian"),
          Jarak(tinggi: 20),
          ...
          Obx(() => _controller.categoryLoading.value
              ...
              : SelectData(
                  ...
                  code: 'adjustment-add-material-category',
                )),
          Jarak(tinggi: 30),
          ...
          Obx(() => _controller.categoryLoading.value
              ...
              : SelectData(
                  ...
                  code: 'adjustment-add-material-account',
                )),
          Jarak(tinggi: 30),
          Container(
              margin: const EdgeInsets.symmetric(horizontal: 20),
              ...
              child: Row(
                ...
                children: [
                  SizedBox(
                    ...
                    child: Text("Masukkan bahan baku penyesuaian",
                        style: TextStyle(
