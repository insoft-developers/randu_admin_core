...
class AdjustmentCategoryController extends GetxController {
  ...
  void getCategoryList(String kataCari) async {
    ...
    if (user != null) {
      ...
      var request =
          await Network().post(data, '/core/adjustment-category-list');
  ...
  void categoryDelete(int id) async {
    var data = {"id": id};
    var res = await Network().post(data, '/core/adjustment-category-delete');
