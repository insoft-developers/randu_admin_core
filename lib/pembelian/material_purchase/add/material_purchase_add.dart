...
class MaterialPurchaseAdd extends StatefulWidget {
  const MaterialPurchaseAdd({super.key});

  @override
  State<MaterialPurchaseAdd> createState() => _MaterialPurchaseAddState();
}

class _MaterialPurchaseAddState extends State<MaterialPurchaseAdd> {
  final MaterialPurchaseAddController _controller =
  ...
  void _materialPurchaseStore() {
    ...
    _controller.materialPurchaseStore(
        _tanggal.text,
      ...
      body: Stack(
        children: [
          ListView(
            ...
            children: [
              ComunTitle(
                  title: 'Tambah Bahan \nBaku', path: "Transaksi Bahan Baku"),
              Jarak(tinggi: 20),
              Judul(
                  ...
                  child: Row(
                    ...
                    children: [
                      SizedBox(
                        ...
                        child: Text("Masukkan item material yang dibeli",
                            style: TextStyle(
                                color: Colors.white,
              ...
              Container(
                ...
                child: Column(
                    ...
                    children: [
                      Text("Penjelasan Fitur Transaksi Beli Bahan Baku",
                          style: TextStyle(fontWeight: FontWeight.bold)),
                      Jarak(tinggi: 5),
                      Text(
                        "Transaksi ini digunakan saat dilakukan pembelian/kulak dari supplier yang mana stok bahan baku akan langsung bertambah setelah transaksi ini sukses dibuat.\n\nHarga Pokok Penjualan / COGS pada Produk yang dibuat akan otomatis tergitung dari Total Transaksi dibagi dengan jumlah bahan baku yang dibeli. Contoh: Jika Total Transaksi = Rp100.000 dan bahan baku yang dibeli adalah 5pcs maka masing masing produknya HPP nya adalah 100.000 / 5 = Rp20.000.\n\nGunakan tipe Utang jika sistem pembeliannya menggunakan sistem Utang.",
