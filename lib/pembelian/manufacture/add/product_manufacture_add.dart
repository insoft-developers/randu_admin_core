...
class ProductManufactureAdd extends StatefulWidget {
  const ProductManufactureAdd({super.key});

  @override
  State<ProductManufactureAdd> createState() => _ProductManufactureAddState();
}

class _ProductManufactureAddState extends State<ProductManufactureAdd> {
  final ProductManufactureAddController _controller =
  ...
  void initState() {
    ...
    _controller.getProductManufactureAccount();
  ...
  void _productManufactureStore() {
    _controller.productManufactureStore(
        _tanggal.text,
        _selectedProduct,
        _pesanan.text,
        _tax.text,
      ...
      body: Stack(
        children: [
          ListView(
            ...
            children: [
              ComunTitle(
                  title: 'Tambah Buat \nProduk', path: "Transaksi Buat Produk"),
              Jarak(tinggi: 20),
              Judul(
              ...
              Obx(() => _controller.bayarPakaiLoading.value
                  ...
                  : SelectData(
                      ...
                      code: 'product-manufacture-account-id',
                    )),
              Jarak(tinggi: 30),
              Judul(
              ...
              Container(
                ...
                child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text("Penjelasan fitur transaksi Buat Produk Manufaktur",
                          style: TextStyle(fontWeight: FontWeight.bold)),
                      Jarak(tinggi: 5),
                      Text(
                        "Stok produk akan langsung bertambah setelah transaksi ini sukses dibuat, dan stok Bahan Baku serta Barang Setengah Jadi akan berkurang otomatis sesuai dengan komposisi bahan pada produk. \n\nHarga Pokok Penjualan / COGS pada Produk yang dibuat akan otomatis tergitung dari Total Transaksi dibagi dengan jumlah produk yang di produksi. Contoh: Jika Total Transaksi = Rp100.000 dan produk yang di produksi adalah 5pcs maka masing masing produknya HPP nya adalah 100.000 / 5 = Rp20.000",
                        textAlign: TextAlign.justify,
                      ),
                      Jarak(tinggi: 10),
                    ]),
