...
class RanduPage extends StatefulWidget {
  const RanduPage({super.key});

  @override
  State<RanduPage> createState() => _RanduPageState();
}

class _RanduPageState extends State<RanduPage> {
            ...
            if (constraints.maxWidth < 600) {
              ...
              return SizedBox(
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    children: [
                      const ComunTitle(title: 'Randu', path: "Dashboards"),
                      _buildlottiui(),
                      _buildpurchasegrup(),
                      _buildSalesgrup(),
                      _buildOrders(),
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                      ...
                      Row(
                        children: [
                          Expanded(flex: 2, child: _buildpaperNote()),
                          Expanded(
                              flex: 1,
                              child: Container(
                                height: 350,
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          gradient: const LinearGradient(
            ...
            colors: <Color>[Color(0xff3da4f0), Color(0xff7366ff)],
          ),
          boxShadow: boxShadow,
        ),
        child: Row(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style:
                            mediumGreyTextStyle.copyWith(color: Colors.white70),
        ...
        _buidComuntile2(
            ...
            trailing: SizedBox(
              ...
              child: SvgPicture.asset("assets/btc-graph.svg",
                  fit: BoxFit.fill, color: const Color(0xff7366ff)),
            ),
            color: Colors.deepPurple),
        _buidComuntile2(
            name: 'Profit',
            ...
            trailing: SizedBox(
              ...
              width: 150,
              child: SvgPicture.asset("assets/btc-graph.svg",
                  fit: BoxFit.fill, color: const Color(0xff37cefa)),
            ),
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                const CircleAvatar(
                                  radius: 3,
                                  backgroundColor: Color(0xffB8E716),
                                ),
                                const SizedBox(
                                  width: 5,
                                ),
                                ...
                                const CircleAvatar(
                                  radius: 3,
                                  backgroundColor: Color(0xff34CAA5),
                                ),
                                const SizedBox(
                                  width: 5,
                                ),
                  ...
                  child: Column(
                    ...
                    children: [
                      _buildcomunlisttile(
                          title: '\$22,678',
                          subtitle: 'Income',
                          icon: 'assets/arrow-down-to-line.svg',
                          price: '+\$45',
                          color: Colors.green),
                      const SizedBox(
                        height: 20,
                      ...
                      _buildcomunlisttile(
                          title: '\$12,057',
                          subtitle: 'Expense',
                          icon: 'assets/hand-holding-dollar.svg',
                          price: '+\$56',
                          color: Colors.red),
                      const SizedBox(
                        height: 20,
                ...
                child: Column(
                  children: [
                    _buildactivtile(
                        ...
                        subtitle: 'Quisque a consequent ante sit amet ma',
                        date: '8th March, 2022',
                        date2: '1 day ago'),
                    const SizedBox(
                      height: 10,
                    ...
                    _buildactivtile(
                        ...
                        subtitle: 'Quisque a consequat ante sit amet ma',
                        date: '15th Oct, 2022',
                        date2: 'Today'),
                    const SizedBox(
                      height: 10,
          ...
          children: [
            Container(
              ...
              child: Center(
                  child: Text(
                date,
                style: const TextStyle(color: Color(0xff9b9cad), fontSize: 14),
              )),
            ),
            const Expanded(
                child: SizedBox(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return ListTile(
                    ...
                    trailing: const Text(
                      "\$200.00",
                      style: TextStyle(color: Color(0xff6dc465)),
                    ),
                  );
                },
              ),
                        ...
                        text: TextSpan(
                            ...
                            children: [
                              TextSpan(
                                  ...
                                  style: mainTextStyle.copyWith(
                                      fontSize: 17,
                                      color: const Color(0xff34CAA5))),
                              TextSpan(
                                  text: " to Explore Primium Features",
                                  style: mainTextStyle.copyWith(
                                      fontSize: 17,
                                      color: notifire!.getMainText))
                            ]),
                      ...
                      text: TextSpan(
                          ...
                          children: [
                            TextSpan(
                                text: " Pro Account ",
                                style: mainTextStyle.copyWith(
                                    fontSize: 17, color: appMainColor)),
                            TextSpan(
                                text: " to Explore Primium Features",
                                style: mainTextStyle.copyWith(
                                    fontSize: 17, color: notifire!.getMainText))
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                decoration: const BoxDecoration(
                    ...
                    image: DecorationImage(
                        image: AssetImage(
                            'assets/82_abstract_geometric_background_vector 1.png'),
                        fit: BoxFit.cover)),
                // height: 140,
                //   width: 550,
              ...
              Padding(
                ...
                child: Text(
                  "Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet saint. Veldt official consequent dues enum veldt mollit.",
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Flexible(
                        child: _buildpapernotecontiner(
                            title: 'SAAS',
                            bgcolor: const Color(0xfff2f3f6),
                            textcolor: const Color(0xff7366ff))),

                    Flexible(
                        child: _buildpapernotecontiner(
                            title: 'Commerce',
                            bgcolor: const Color(0xffe6f5e4),
                            textcolor: const Color(0xff6dc465))),

                    Flexible(
                        child: _buildpapernotecontiner(
                            title: 'Crypto',
                            bgcolor: const Color(0xfffff6e6),
                            textcolor: const Color(0xfffeb629))),

                    Flexible(
                        child: _buildpapernotecontiner(
                            title: 'Project',
                            bgcolor: const Color(0xffd3f4fe),
                            textcolor: const Color(0xff62b4fc))),

                    Flexible(
                        child: _buildpapernotecontiner(
                            title: 'NFT',
                            bgcolor: const Color(0xffffeff3),
                            textcolor: const Color(0xfffc4438))),

                    Flexible(
                        child: _buildpapernotecontiner(
                            title: '+9',
                            bgcolor: const Color(0xffe9e9ee),
                            textcolor: const Color(0xff52526c))),
  ...
  Widget _buildpapernotecontiner(
      {required String title,
